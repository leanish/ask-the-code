...
`GET /` always returns the HTML page. Programmatic clients should use the dedicated JSON endpoints (`GET /repos`, `GET /health`, `POST /ask`, `GET /jobs/:id`, `GET /jobs/:id/events`).
